...
summary= "در این پست به این می‌پردازیم که چطور با ابزارهای سادهٔ unix لینک‌های دانلود ترتیبی مثال بازی یا سریال رو با هم دانلود کنیم."
...
اگر این روش به درستی لینک‌ها رو تولید کنه، کافیه به جای `echo` دستور `wget` بزاریم و تمام. ولی اگر به عدد مشخص شده برای شمارهٔ لینک‌ها دقت کنیم می‌بینیم که اعداد zero pad هستن:
